            ...
            <div className="lg:w-1/2 h-screen px-[8%] lg:px-[3.5%] pt-[15%] lg:pt-[4%]">
              ...
              <div className="space-y-[5%]">
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  ...
                  <h1 className="group-hover:text-yellow-200">News</h1>
                </div>
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  <div className="w-[4%] h-[2px] group-hover:bg-yellow-200 duration-700" />
                  <h1 className="group-hover:text-yellow-200">Events</h1>
                </div>
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  <div className="w-[4%] h-[2px] group-hover:bg-yellow-200 duration-700" />
                  <h1 className="group-hover:text-yellow-200">Donations</h1>
                </div>
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  <div className="w-[4%] h-[2px] group-hover:bg-yellow-200 duration-700" />
                  <h1 className="group-hover:text-yellow-200">
                    Alumni Mengajar
                  </h1>
                </div>
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  <div className="w-[4%] h-[2px] group-hover:bg-yellow-200 duration-700" />
                  <h1 className="group-hover:text-yellow-200">Expo Campuss</h1>
                </div>
                <div className="group flex items-center ml-[-7%] space-x-[2%] font-nocturno-light text-headline-medium text-white cursor-pointer transition-all ease-in-out">
                  <div className="w-[4%] h-[2px] group-hover:bg-yellow-200 duration-700" />
                  <h1 className="group-hover:text-yellow-200">Guyub Rukun</h1>
                </div>
              </div>
            </div>
          </div>
